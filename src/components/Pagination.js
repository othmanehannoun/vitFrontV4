...
const Pagination = ({setItemId, itemKey}) => {
  ...
  useEffect(()=>{
    LogBox.ignoreLogs(["Cannot update a component (`Pagination`) while rendering a different component (`CellRenderer`). To locate the bad setState() call inside `CellRenderer`, follow the stack trace as described in https://reactjs.org/link/setstate-in-render"]);
  },[])
