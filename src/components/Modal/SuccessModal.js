  ...
  return (
    <View>
      <ModalPoup visible={visible}>
        ...
        <View style={{alignItems: 'center'}}>
          <Feather name='check-circle' size={90} color={'#1dd1a1'}/>
        </View>
        <View style={{alignItems: "center", marginVertical: 30}}>
            <Text style={{color: 'black', fontWeight: 'bold', fontSize: 22}}>Succès</Text>
        ...
        <View style={{alignItems: 'center', }}>
          <TouchableOpacity style={styles.ModalBtn} onPress={() => setVisible(false)}>
              ...
              <View style={{backgroundColor: 'white', borderRadius: 50, padding: 2}}>
                <Feather name='arrow-right' size={15} color={'#1dd1a1'}/>
              </View>
          </TouchableOpacity>
        </View>
      </ModalPoup>
